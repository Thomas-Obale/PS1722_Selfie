...
UDP_IP="192.168.1.255" #Broadcast address to send sockets to all Pi's
maskingPI="192.168.1.10"
projectID = ""
...
def displayExistingProjects():
    ...
    projects = urllib.request.urlopen("http://pi3d.scem.ws/selfie/v1/projects") #get the projects
...
def addNewProject():
    ...
    post = requests.post('http://pi3d.scem.ws/selfie/v1/projects', data = {'name': name}) 
...
def deleteProject():
    ...
    post2 = requests.delete('http://pi3d.scem.ws/selfie/v1/projects/' + str(deleteID), data = {'id': deleteID})
    print (post2.text) 
...
def postImages():
    ...
    while(allowCapture):
        ...
        if keyInput == "":
            ...
            update_queue =requests.put('http://pi3d.scem.ws/selfie/v1/photoscan_queues/update/' + str(projectID.decode('utf-8')), data = {'status': 'ready_for_processing'})
